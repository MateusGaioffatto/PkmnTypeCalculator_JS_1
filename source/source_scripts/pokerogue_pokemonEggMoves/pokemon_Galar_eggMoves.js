export const pokerogue_pokemonEggMoves_Galar = {
  ...
  eldegoss: ["Baton Pass", "Tailwind", "Sappy Seed", "Spore"],

  wooloo: ["Nuzzle", "Milk Drink", "Body Press", "Multi Attack"],
  dubwool: ["Nuzzle", "Milk Drink", "Body Press", "Multi Attack"],
  ...
  barraskewda: ["Supercell Slam", "Triple Dive", "Ice Spinner", "Swords Dance"],
  ...
  polteageist: ["Splishy Splash", "Matcha Gotcha", "Draining Kiss", "Moongeist Beam"],
  ...
  frosmoth: ["Frost Breath", "Heal Order", "Earth Power", "Spore"],
  ...
  dragapult: ["Shadow Bone", "Power Up Punch", "Fire Lash", "Dire Claw"],
  ...
  rapid_strike_urshifu: ["Meteor Mash", "Drain Punch", "Jet Punch", "Dragon Dance"],
